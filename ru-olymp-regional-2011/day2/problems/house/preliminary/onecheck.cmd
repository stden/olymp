...
if "%2" == "" (
    ...
    if EXIST ..\%problem_name%_%1.exe run -t 5 -m 256M ..\%problem_name%_%1.exe
    if EXIST ..\%problem_name%_%1.class run -t 2 -m 256M java -Xss64M -Xmx256M -cp .. %problem_name%_%1
