...
// Неправильное решение --- не вычитается число троек,
// в которых все точки лежат на одной прямой

import java.io.*;
import java.util.*;

public class triangle_ft_wrong implements Runnable {
	...
	public static void main(String[] args) {
		...
		new Thread(new triangle_ft_wrong()).start();
	}
