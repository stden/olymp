...
// Из серии --- найдите 10 различий с правильным решением
// Происходит переполнение 32-битного типа данных.

import java.io.*;
import java.util.*;

public class lawn_vu_32bit {
	public static void main(String[] args) throws IOException {
		...
		int x3 = in.nextInt(), y3 = in.nextInt(), r = in.nextInt();
		...
		long ans = 0;		
		for (int x = Math.max(x1, x3 - r); x <= Math.min(x2, x3 + r); x++) {
