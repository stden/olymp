...
//Неверное решение: не учтено то, что число не может начинаться с нуля, если это не ноль 
import java.io.*;
import java.math.*;
import java.util.*;

public class numbers_af_wrong implements Runnable {
    public static void main(String[] args) {
        new Thread(new numbers_af_wrong()).start();
    }
