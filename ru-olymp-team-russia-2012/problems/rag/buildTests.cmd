...
set lang=java
set validator=Validate
rem ValidateAdjacent

echo Generating tests...
if not exist tests mkdir tests
cd src
javac TestGen.java
java -Xmx256M TestGen
cd ..
...
del validate.jar
if not exist %validator%.java goto novalidate

echo Compiling validator...

rmdir /S /Q __tmp 2> nul
mkdir __tmp
javac -sourcepath . -d __tmp %validator%.java
pushd __tmp
mkdir META-INF
echo Main-Class: %validator%> META-INF/manifest.1
