	...
	while (v1 + v2 <= n) do begin
		if (x1[v1] < x2[v2]) then begin
			...
			repeat
				...
				if x2[v2] >= x1[v1] + dx then begin
					ok := (y1[v1] + dy - y2[v2 - 1]) * (x2[v2] - x2[v2 - 1]) < (x1[v1] + dx - x2[v2 - 1]) * (x1[v1] + dx - x2[v2 - 1]);
				end;
			until ok;
			inc(v1);
			x1[v1] := x1[v1 - 1] + dx;
			...
			repeat
				...
				if x1[v1] >= x2[v2] + dx then begin
					ok := (y2[v2] + dy - y1[v1 - 1]) * (x1[v1] - x1[v1 - 1]) > (x2[v2] + dx - x1[v1 - 1]) * (x2[v2] + dx - x1[v1 - 1]);
				end;               
			until ok;
			inc(v2);
			x2[v2] := x2[v2 - 1] + dx;
