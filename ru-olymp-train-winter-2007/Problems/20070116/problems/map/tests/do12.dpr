...
Begin
  ...
  repeat
  	...
  	first := TTree.CreateSubstitution(TTree.CreateSubstitution(TTree.CreateRandom(10), TTree.CreateStar(4)), outer1).shuffle;
  	second := TTree.CreateSubstitution(TTree.CreateSubstitution(TTree.CreateRandom(15), TTree.CreateStar(4)), outer2).shuffle;
