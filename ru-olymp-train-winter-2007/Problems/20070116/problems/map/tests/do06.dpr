...
Begin
  ...
  TTree.CreateFullSubstitution(TTree.CreateChain(25), TTree.CreateStar(4)).WriteOut();
  TTree.CreateFullSubstitution(TTree.CreateChain(40), TTree.CreateStar(12)).Shuffle().WriteOut();
End.