...
Begin
  ...
  outer1 := TTree.CreateRandom(30);
  outer2 := outer1.duplicate();
  TTree.CreateSubstitution(TTree.CreateRandom(10), outer1).WriteOut;
  TTree.CreateSubstitution(TTree.CreateRandom(30), outer2).WriteOut;
End.