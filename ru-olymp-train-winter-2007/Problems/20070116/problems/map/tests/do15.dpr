...
Begin
  ...
  repeat
  	...
  	u := random(20) + 2;
  	first := TTree.CreateSubstitution(TTree.CreateFullSubstitution(TTree.CreateRandom(random(10) + 1), TTree.CreateChain(u)), outer1).shuffle;
  	second := TTree.CreateSubstitution(TTree.CreateFullSubstitution(TTree.CreateRandom(random(20) + 1), TTree.CreateChain(u)), outer2).shuffle;
