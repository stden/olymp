...
Begin
  ...
  repeat
  	outer1 := TTree.CreateRandom(random(50) + 1);
  	...
  	second := TTree.CreateSubstitution(TTree.CreateFullSubstitution(TTree.CreateRandom(random(20) + 1), TTree.CreateStar(random(8) + 2)), outer2).shuffle;
