...
if "%2" == "" (    
    ...
    if EXIST %problem_name%_%1.exe run -t 2 -m 64M %problem_name%_%1.exe
    if EXIST %problem_name%_%1.class run -Xifce -t 2 -m 64M java -Xss64M %problem_name%_%1
