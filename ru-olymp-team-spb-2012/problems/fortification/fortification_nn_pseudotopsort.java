...
/**
 * Correct pseudo-topsort. First sort the chains. Then sort the cycles. Then the
 * length of an edge in Graph embedded on a line, is the (length of the cycle) - 1.
 * 
 * @author niyaz.nigmatullin
 * 
 */
public class fortification_nn_pseudotopsort {
