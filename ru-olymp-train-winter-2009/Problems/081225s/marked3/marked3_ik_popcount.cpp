...
{
 k = ((k >>  1) & 0x55555555) + (k & 0x55555555);
 k = ((k >>  2) & 0x33333333) + (k & 0x33333333);
 k = ((k >>  4) & 0x0F0F0F0F) + (k & 0x0F0F0F0F);
 k = ((k >>  8) & 0x00FF00FF) + (k & 0x00FF00FF);
 k = ((k >> 16) & 0x0000FFFF) + (k & 0x0000FFFF);
 return k;
}
