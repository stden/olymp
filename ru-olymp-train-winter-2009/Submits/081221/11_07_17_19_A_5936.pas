...
Var g:Array[1..50,1..50]of Integer;
    price,disc:Array[1..50,0..6] of Integer;
    nCurIt,mx,my,nmin,v1,v2,x,y,i,j,n,m,k,st:Integer;
    it:Array[1..50]of Integer;
    d:Array[1..50,0..127] of Integer;
    use:Array[1..50,0..127]of Boolean;
    need:Integer;
    CurIt:Array[0..6] of Integer;
    take:Array[0..6]of Boolean;
    check:TCheck;
