...
var
        ...
        Alldisco:array[1..255,1..maxn]of integer;
...
begin
        ...
        for i:=1 to nn-1 do begin
                ...
                for l:=1 to n do begin
                        AllDisco[i]:=Alldisco[min];
                        for j:=1 to k do
                                if d[min or Additem[j]]>
                                        d[min]+a[tek[min],l]+
                                        (Price[l,j]div 100*(100-AllDisco[min,l]))then
                                begin
                                        AllDisco[min or AddItem[j],l]:=AllDisco[min,l]+Disco[l,j];
                                        D[min or AddItem[j]]:=
                                                d[min]+a[tek[min],l]+
                                                (Price[l,j]div 100*(100-AllDisco[min,l]));
