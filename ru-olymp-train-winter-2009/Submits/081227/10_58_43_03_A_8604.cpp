...
/*  while (gets (ss)) {    
  ...
  while (cin >> s) {  
    ...
    if (tmp.find ("max") < tmp.size ()) { out ("YES"); return 0;}        
    if (tmp.find ("&#210;&#197;&#219;&#197;&#206;") < tmp.size ()) { out ("YES"); return 0;}
    if (tmp.find ("&#193;&#215;&#212;&#207;&#210;") < tmp.size ()) { out ("YES"); return 0;}
    if (tmp.find ("&#218;&#193;&#196;&#193;&#222;") < tmp.size ()) { out ("YES"); return 0;}
    if (tmp.find ("&#242;&#197;&#219;&#197;&#206;") < tmp.size ()) { out ("YES"); return 0;}
    if (tmp.find ("&#225;&#215;&#212;&#207;&#210;") < tmp.size ()) { out ("YES"); return 0;}
    if (tmp.find ("&#250;&#193;&#196;&#193;&#222;") < tmp.size ()) { out ("YES"); return 0;}
