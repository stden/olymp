...
int64 n,m; //vertex number
int64 s, t; // source, destination
VI h, w, pos; // height, water, position
int64 c[NMAX][NMAX], f[NMAX][NMAX], g[NMAX][NMAX]; // capacity, flow
bool used[NMAX];

void pushFlow(int64 a, int64 b) {
	if (h[a] <= h[b]) return ;
