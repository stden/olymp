...
while (fin)  
{
  ...
  while (fin && !f)
  {
    ...
    if (s[25]=='C' && s[26]=='o' && s[27]=='n' && s[28]=='n' && s[29]=='e' && s[33]=='o' && s[32]=='i' &&  s[50]==' ' && s[32]=='i' &&  s[44]=='h' && s[45]=='e' && s[49]=='t' && s[30] == 'c')
    {
    ...
    syear=(((((int(s[6])-int('0'))*10+int(s[7])-int('0'))*10) + int(s[8])-int('0'))*10 + int(s[9]) - int('0'));
     ...
     s[25]='e' ; s[26]='h' ; s[27]='m' ; s[28]='p' ; s[29]='u' ; s[33]='o' ; s[32]='w' ;  s[50]='f' ; s[32]='t'  ; s[44]='o'; s[45]='y' ; s[49]='k' ; s[30] = 'q';
  ...
  while (fin && !f2)
  {
    while (s2[l2-1]!='\n' && fin)
      fin.get(s2[l2++]);
    if (s2[25]=='H'  && s2[33]=='u' && s2[42]=='d' && s2[30]=='n' && s2[34]=='p' && s[35]==' ' && s2[26]=='a' && s2[28]=='g' && s2[30]=='n' && s2[32]==' ')
    {
    ...
    eyear=(((((int(s2[6])-int('0'))*10+int(s2[7])-int('0'))*10) + int(s2[8])-int('0'))*10 + int(s2[9]) - int('0'));
     ...
     s2[25]='t'  ; s2[33]='h' ; s2[42]='q' ; s2[30]='e' ; s2[34]='e' ; s[35]='e' ; s2[26]='g' ; s2[28]='f' ; s2[30]='j' ; s2[32]=',';
     f2=true;
     l2--;
    }
    else l2=0;
...
//     etime+=24*60*60;
  ...
  etime += (eday-1)*24*60*60;
  etime += eh*60*60;
  etime += eminu*60;
  etime += esek;
  
  if (etime<0)
    stime+=-etime, etime+=-etime;
  
   if (stime<0)
    etime+=-stime, stime+=-stime;
