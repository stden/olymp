...
var
        ...
        d,Tek,TekLast,LastD:array[-1..255]of integer;
        use:array[-1..255]of boolean;
        n,m,k,v,i,j,l,KolLast,min:integer;
        v1,v2,w:integer;
        nn:integer;
begin
                ...
                for l:=1 to n do begin
                        for j:=1 to k do
                                ...
                                begin
                                        ...
                                        if (min or AddItem[j])=nn then begin
                                           inc(KolLast);
                                           TekLast[KolLast]:=l;
                                           LastD[KolLast]:=D[min or AddItem[j]];
                                        end;
                                end;
                end;
                use[min]:=true;
        ...
        min:=2*inf;
        for i:=1 to KolLast do
            if LastD[i]+a[TekLast[i],v]<min then min:=LastD[i]+a[TekLast[i],v];
        if min>=inf then write(-1)else write(min);
end.
