...
g++ -x c++ -O2 -Wall -Wl,--stack=67108864 %1.cpp -o %1.exe
rem wcl386 /k16777216 /fm /oxt /5r %1.cpp
goto testexe
:dojava
javac %1.java
goto testclass
:dowc
g++ -x c -O2 -Wall -Wl,--stack=67108864 %1.c -o %1.exe
rem wcl386 /k16777216 /fm /oxt /5r %1.c
goto testexe
:dodelphi
call mydcc %1
goto testexe
